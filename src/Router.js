...
class RouterComponent extends Component {
  render() {
    return (
      <Router navigationBarStyle={styles.navBar} titleStyle={styles.navTitle} sceneStyle={{marginTop:65}}>
          <Scene key="root" >
          ...
          <Scene key="main" >
            ...
            <Scene key='categoryPage' component={CategoryComponent} title='Kategori' onRight={()=>{Actions.categoryAddPage()}}
